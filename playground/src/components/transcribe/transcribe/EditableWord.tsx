...
export const EditableWord = (props: EditableWordProps) => {
  ...
  const canDrawDeleteIcon = () => {
    ...
    return (
      props.operation === TextSelectionOperation.REMOVE &&
  ...
  const drawWord = () => {
    return (
      <span
        data-chapteridx={props.chapterIdx}
  ...
  return canDrawDeleteIcon() ? (
    <div className="flex">
      {drawWord()}
      <button
        className="bg-red-500 px-1 py-0 h-6 rounded-md relative right-[10px] bottom-[8px]"
