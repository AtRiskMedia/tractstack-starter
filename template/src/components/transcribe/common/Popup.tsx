    ...
    return (
        <div className={getRootClass()}>
            <div className="modal-overlay absolute w-full h-full bg-gray-900 opacity-50"
                 onClick={() => close()}></div>
            <div
                className="modal-container bg-white w-[800px] h-[600px] mx-auto rounded shadow-lg z-50 overflow-y-auto">
                <div className="modal-content py-4 text-left px-6">
                    <div className="flex justify-between items-center pb-3">
                        ...
                        <button className="px-4 bg-purple-500 p-3 ml-3 rounded-lg text-white hover:bg-purple-400"
                                onClick={() => close()}>
                            Close
                        </button>
                    </div>
